...
function SquadCardHome({ squad }: { squad: ReturnType<typeof getAllSquadCards>[0] }) {
  ...
  return (
    <Link href={`/squads/${squad.id}`} className="group block bg-white rounded-2xl border border-gray-100 hover:border-sky-200 hover:shadow-lg transition-all duration-200 overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-fuchsia-500 to-pink-400 p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-sky-100 text-xs ml-2">揪團</span>
          </div>
        </div>
    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-fuchsia-500 via-fuchsia-400 to-pink-300 text-white">
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24">
          <div className="max-w-2xl">
            ...
            <p className="text-sky-100 text-lg md:text-xl mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link
                href="/squads/new"
                className="flex items-center justify-center gap-2 bg-sky-600 text-white px-6 py-3 rounded-xl font-semibold border border-sky-400 hover:bg-sky-500 transition-colors"
              >
                發起揪團
              </Link>
            </div>
      ...
      <section className="max-w-6xl mx-auto px-4 mb-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/squads" className="text-sm text-sky-500 hover:text-sky-600 font-medium">
            看全部 →
          </Link>
        </div>
          ...
          {SPORT_LIST.map(sport => {
            ...
            return (
              <Link
                ...
                className="flex items-center gap-2 bg-white border border-gray-100 hover:border-sky-200 hover:shadow-md rounded-xl px-4 py-3 whitespace-nowrap transition-all"
              >
      ...
      <section className="max-w-6xl mx-auto px-4 mb-12">
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-8 text-center">
          ...
          <Link
            href="/squads/new"
            className="inline-flex items-center gap-2 bg-sky-500 hover:bg-sky-400 text-white px-6 py-3 rounded-xl font-semibold transition-colors"
          >
            發起揪團
            <ArrowRight className="w-4 h-4" />
          </Link>
