...
import { SPORT_LABELS, SKILL_LABELS, type SportType, type Profile } from '@/lib/types'
import { mockProfiles } from '@/lib/mock-data'
import { format } from 'date-fns'

export default function ProfilePage() {
  const profile = mockProfiles.find(p => p.id === 'u1')!
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {SPORTS.map(sport => {
                ...
                const active = form.preferred_sports.includes(sport)
                return (
                  <button
                    key={sport}
